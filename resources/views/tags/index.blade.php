<x-app-layout>
    <x-slot name="header">
        ...
        <button class="btn--primary ms-auto" x-data=""
                               x-on:click.prevent="$dispatch('open-modal', 'form-new-tag-group'); $dispatch('button-new-tag-group-click', '');">
    ...
    <div class="py-12" x-data="tagIndex()" x-init="flashMessage()" x-on:button-new-tag-group-click.window="formNewTagGroupProps.action = '{{ route('tag-groups.store') }}'; formNewTagGroupProps.method = 'post'; formNewTagGroupProps.buttonText = '{{ __('Save') }}';">
